...
set AssimpIncludeDir="..\external\assimp-5.0.1\include"
set AssimpLibDir=..\external\assimp-5.0.1\lib\RelWithDebInfo
...
del lock.tmp
call cl %CommonCompilerFlags% -DDLL_NAME=pbr_demo %CodeDir%\win32_main.cpp -Fmwin32_main.map /link %CommonLinkerFlags%
